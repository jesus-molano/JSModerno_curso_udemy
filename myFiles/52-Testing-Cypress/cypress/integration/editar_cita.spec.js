...
describe('Llenar los campos del form y edita la cita', () => {
	...
	it('Edita la cita correctamente', () => {
		cy.get('.btn-editar').click();
		cy.get('[id="mascota"]').clear().type('Ronaldo');
		cy.get('.btn-primary').click();
		cy.get('.alert') // mala practica clases or id
			.should('have.class', 'alert-success')
			.invoke('text')
			.should('equals', 'Guardado Correctamente');
	});
});
