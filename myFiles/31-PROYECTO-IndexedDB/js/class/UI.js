...
class UI {
  ...
  imprimirCitas() {
    ...
    // Conseguir el total de elementos para cambiar el encabezado
    const total = objectStore.count();
    total.onsuccess = function () {
      fnTextoHeading(total.result);
    };

    // El cursor se encarga de ir iterando en los elementos de la DB
    objectStore.openCursor().onsuccess = function (event) {
      ...
      if (cursor) {
        ...
        // Ir al siguiente elemento del Cursor de la DB
        cursor.continue();
      }
    };
  }
